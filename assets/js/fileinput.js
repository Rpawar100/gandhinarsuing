...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tTagBef1 = tTagBef + '><div class="kv-file-content" style="width: 100%;">\n';
            tTagBef2 = tTagBef + ' title="{caption}"><div class="kv-file-content" style="width: 100%;">\n';
            tTagAft = '</div>{footer}\n{zoomCache}</div>\n';
            tGeneric = '{content}\n';
            tStyle = ' {style}';
    ...
    $.fn.fileinput.defaults = {
        ...
        browseIcon: '<i class="glyphicon glyphicon-folder-open" style="font-size: initial;"></i>&nbsp;',
        browseClass: 'btn btn-primary',
        removeIcon: '<i class="glyphicon glyphicon-trash" style="font-size: initial;"></i>',
        removeClass: 'btn btn-default btn-secondary',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle" style="font-size: initial;"></i>',
        cancelClass: 'btn btn-default btn-secondary',
        pauseIcon: '<i class="glyphicon glyphicon-pause" style="font-size: initial;"></i>',
        pauseClass: 'btn btn-default btn-secondary',
        uploadIcon: '<i class="glyphicon glyphicon-upload" style="font-size: initial;"></i>',
