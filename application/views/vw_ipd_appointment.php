    ...
    <div class="col-lg-12" id="ipd_appointment_tabel">
      <div class="ibox-title"  style="padding-top: 10px !important;padding-right: 20px;">
          <div class="row" >
            ...
            <div class="col-lg-2">
              <a href="<?=base_url()?>opd-appointment" tabindex="-1"><button class="btn btn-primary pull-right " style="top: 0; 1%;
              font-size: medium;"><i class="fa fa-plus"></i>OPD Registration</button></a>
            </div>

            <div class="col-lg-2">
              <button class="btn btn-primary pull-right "  onclick="show_ipd_appointment_form()" style="top: 0; 1%;
 font-size: medium;"><i class="fa fa-plus"></i>Add New Registration</button>
            </div>
          </div>
      </div><br>
...
<div class="container">
    <div class="row">
      <div class="col-md-3">
        <div class="card" style="background-color: #60aad9 !important; border-radius:10px;" id="live_patient_link">
          <div class="card-body">
            <h3 class="card-title" style="text-align: center; color: white !important;font-size: 49px;
"><?php echo $inprocess_count; ?></h3>
            <h4 class="card-title" style="text-align: center;color: white !important;">Live Patient</h4>
      ...
      <div class="col-md-3">
        <div class="card" style="background-color: #60aad9 !important; border-radius:10px;" id="new_patient_link">
          <div class="card-body">
            <h3 class="card-title" style="text-align: center;color: white !important;font-size: 49px;
"><?php echo $total_ipd_new_appointments; ?></h3>
            <h4 class="card-title" style="text-align: center;color: white !important;">New Patient</h4>
      ...
      <div class="col-md-3">
        <div class="card" style="background-color: #60aad9 !important; border-radius:10px;" id="discharge_patient_link">
          <div class="card-body">
            <h3 class="card-title" style="text-align: center;color: white !important;font-size: 49px;
"><?php echo $total_completed_appointments; ?></h3>
            <h4 class="card-title" style="text-align: center;color: white !important;">Discharged Patient</h4>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row" id="ipd_appointment_form">
    <div class="col-lg-12" >
      <div class="ibox-title"  style="padding-top: 10px !important;">
        <h2><b>New IPD Registration</b></h2> 
        <button class="btn btn-primary show-inward-table pull-right" onclick="show_ipd_appointment_table()"><b>Appointment List</b></button>
      </div>
        <div class="ibox-content" style="padding: 0px;">
            <!-- <div id="accordion" class="accordion">
                    ...
                    <div class="card-body">
                      <form method="post"  enctype="multipart/form-data" id="search_patient_form">
                        <div class="row" style="margin:  0px;">
                          <label class="form-control col-lg-2" style="border:0px;">UHID</label>
                          ...
                          <button class="btn btn-danger col-lg-2" type="reset">Reset</button>
                        </div>
              ...
              <!-- Modal Structure -->
    <div class="modal fade" id="searchPatientModal" tabindex="-1" role="dialog" aria-labelledby="searchPatientModalLabel" aria-hidden="true" style="display: block;opacity: 1;">
        <div class="modal-dialog" role="document">
                      ...
                      <form method="post"  enctype="multipart/form-data" id="search_patient_form">
                        ...
                        <div style="margin: 0px;margin-top: 5px;">
                          ...
                          <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="row" style="display: flex; flex-wrap: nowrap;">
                                    <label class="form-control col-lg-2" style="border:0px; font-size: large!important;">UHID:</label>
                                     <input class="form-control" type="text" name="search_uhid" id="search_uhid" oninput="this.value = this.value.toUpperCase()" placeholder="UHID">
                                </div>
                            </div><br>
                            ...
                            <button class="btn btn-danger col-lg-2" type="reset">Reset</button>
                            <button class="btn btn-primary col-lg-2" type="submit" style="margin-left: 1%;">Search</button>
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion" >
                         ...
                         <!--  <div class="row" style="margin:0px;margin-top: 30px;" >
                          ...
                          <div class="row" style="margin:0px;margin-top: 5px;">
                            <div class="col-8">
                              <div class="row" style="display: flex; flex-wrap: nowrap;">
                               <label class="form-control " style="border:0px;">Full Address<a style="color: red">*</a></label>                            
                               <input class="form-control col-lg-10" type="text" id="per_address" name="per_address" required="" oninput="this.value = this.value.toUpperCase()">
                              </div>
                            </div>
                            <!--
                           ...
                           <div class="row" style="display: flex;  flex-wrap: wrap;  margin-left: 9%;">                         
                           <div class="col-8">
                               <div class="col-lg-2">
            ...
            <form method="post"  enctype="multipart/form-data" id="ipd_appointment_formdata">
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          ...
                          <div class="row" style="margin: 10px 0px;">
                            ...
                            <div class="col-8">
                             <div class="row" style="display: flex; flex-wrap: nowrap;">
                               <label class="form-control col-lg-2" style="border:0px;">Treating Doctor</label>
                             ...
                             <div class="col-8">
                             <div class="row" style="display: flex; flex-wrap: nowrap;">
                              <label class="form-control col-lg-2" style="border:0px;">Secondary Doctor</label>
                              <select class="form-control selectpicker" name="secondary_doctor" id="secondary_doctor" data-live-search="true"  name="user_id" >
                                <option value="" selected="" disabled="">Select Doctor</option>
                              </select>
                            </div>
                            </div>
                            <div class="col-8">
                             <div class="row" style="display: flex; flex-wrap: nowrap;">
                             <label class="form-control col-lg-2" style="border:0px;">Admission Date<a style="color: red">*</a></label>
                          ...
                          <div class="row" style="margin: 10px 0px;">                            
                            <div class="col-8">
                              <div class="row" style="display: flex; flex-wrap: nowrap;">
                              <label class="form-control col-lg-2" style="border:0px;">Floor</label>
                            ...
                            <div class="col-8">
                              <div class="row" style="display: flex; flex-wrap: nowrap;">
                              <label class="form-control col-lg-2" style="border:0px;" >Billing Class</label>
                              <select class="form-control" name="ward_number" id="ward_number" required="">
                                <option value='' selected disable>Select Billing Class</option>
                              </select>
                            </div>
                            </div>
                            ...
                            <div class="col-8">
                             <div class="row" style="display: flex; flex-wrap: nowrap;">
                              <label class="form-control col-lg-2" style="border:0px;" >Room Number</label>
                              <select class="form-control" name="room_number" id="room_number" required="">
                                <option value='' selected disable>Select Room</option>
                              </select>
                            </div>
                            </div>

                            <button type="button" class="btn btn-primary check_bed_availability_model" data-toggle="modal" id="bedDetailsModal" data-target="#bedDetailsModal">Check Bed Availability</button>
                            <div class="col-8">
                             <div class="row" style="display: flex; flex-wrap: nowrap;">
                              <label class="form-control col-lg-2" style="border:0px;">Bed Number</label>
                              <select class="form-control" name="bed_number" id="bed_number" required="">
                                <option value='' selected disable>Select Bed</option>
                              </select>
                            </div>
                            </div>
                            <div class="col-lg-1" style="font-size: 20px;">
                                <input  type="checkbox" id="MLC" name="MLC">
                                <label for="MLC" style="font-size: 20px;"> MLC</label>  
                            </div>
                          </div>
                        
                          <div class="row" style="margin: 10px 0px;">
                            <div class="col-8 emp_info_div">
                              <div class="row" style="display: flex; flex-wrap: nowrap;">
                            ...
                            <div class="col-8 insurance-info-div">
                            <div class="row" style="display: flex; flex-wrap: nowrap;">
                            ...
                            <div class="col-8 ">
                            <div class="row" style="display: flex; flex-wrap: nowrap;">
                              <label class="form-control col-lg-2" style="border:0px;">Health Card No</label>
                          ...
                          <div class="row" style="margin: 10px 0px;">
                            ...
                            <div class="col-8">
                            <div class="row" style="display: flex; flex-wrap: nowrap;">
                              <label class="form-control col-lg-2" style="border:0px;">Reference Hospital</label>
                              <input class="form-control" type="text" name="ref_hospital" id="ref_hospital" oninput="this.value = this.value.toUpperCase()">
                            </div>
                            </div>
                            <div class="col-8">
                            <div class="row" style="display: flex; flex-wrap: nowrap;">
                              <label class="form-control col-lg-2" style="border:0px;" >Reference Doctor</label>
                          ...
                          <div class="row" style="margin: 10px 0px;">
                            <div class="col-8">
                            <div class="row" style="display: flex; flex-wrap: nowrap;">
                              <label class="form-control col-lg-2" style="border:0px;">Relative Name<a style="color: red">*</a></label>
                               <input class="form-control" type="text" name="relative_name" id="relative_name" oninput="this.value = this.value.toUpperCase()" required="">
                            </div>
                            </div>
                            <div class="col-8">
                            <div class="row" style="display: flex; flex-wrap: nowrap;">
                            <label class="form-control col-lg-2" style="border:0px;">Relationship<a style="color: red">*</a></label>
                              <select class="form-control" name="relative_relationship" id="relative_relationship" required="">
                               <option value="" selected="" disabled="">Select Relation</option>
                               <option value="Father">Father</option>
                               <option value="Mother">Mother</option>
                               <option value="Sister">Sister</option>
                               <option value="Brother">Brother</option>
                               <option value="Brother">Spouse</option>
                               <option value="Other">Other</option>
                              </select>
                            </div>
                            </div>
                            <div class="col-8 other_name">
                            <div class="row" style="display: flex; flex-wrap: nowrap;">
                            <label class="form-control other_name col-lg-2" style="border:0px;">Enter Relation</label>
                            <input class="form-control" type="text" name="other_name" id="other_name">
                            </div>
                            </div>
                            <div class="col-8">
                            <div class="row" style="display: flex; flex-wrap: nowrap;">
                              <label class="form-control col-lg-2" style="border:0px;">Relative Contact Number<a style="color: red">*</a></label>
                              <input class="form-control" type="text" name="relative_contact" id="relative_contact" required="">
                            </div>
                            </div>
...
<div class="modal fade" id="search_patient_modal" role="dialog" style="opacity: 1;">
...
<div class="modal fade" id="pay_bill_modal" role="dialog">
  <div class="modal-dialog" style="min-width: max-content;">
    <div class="modal-content">
      <form method="post"  enctype="multipart/form-data" id="ipd_payment_form">
        <div class="modal-header">
          <h3 class="modal-title">IPD Bill Payment</h3>
        ...
        <div class="modal-body" style="font-size: medium">
          ...
          <div class="row" style="margin: 10px 0px;">
            <label class="control-label col-lg-5">Service Charge<a style="color: red">*</a><b class="pull-right">:</b></label>
            <div class="col-lg-7">
          ...
          <div class="row" style="margin: 10px 0px;">
            ...
            <div class="col-lg-7">
              <input class="form-control" type="text" name="cash_amount" id="service_charge"> 
              
            </div>
          </div>
          <div class="row" style="margin: 10px 0px;">
            <label class="control-label col-lg-5">Bank<a style="color: red">*</a><b class="pull-right">:</b></label>
            <div class="col-lg-7">
              <input class="form-control" type="text" name="bank_amount" id="service_charge"> 
              
            </div>
          </div>

          <div class="row" style="margin: 10px 0px;">
            <label class="control-label col-lg-5">Payment Mode<a style="color: red">*</a><b class="pull-right">:</b></label>
            <div class="payment-options col-lg-7">
    ...
    <div class="modal-dialog " style="max-width: 1000px;border-radius: 15px;">
      <div class="modal-content" style="border-radius: 15px;">
          <div class="modal-body">
            <div class="row" style="margin-bottom: 15px;">
              <div class="col-lg-12" >
                <h2  style="margin: 0px;float: left;">IPD Registartion Receipt</h2>
...
<!-- Modal -->
<div id="bed_availability_modal" class="modal fade" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Bed Availability</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<script type="text/javascript">
  $(document).on('click', '.check_bed_availability_model', function () {

    var floor_no = $('#floor_number').val();
    var billing = $('#ward_number').val();
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if (data.success) {
          // Generate grid HTML
          var gridHtml = '<div class="bed-grid">';
          
          $.each(data.data, function(index, bed) {
            var bedColor = bed.bed_appointment_id ? 'red' : 'green';
            var bedStatus = bed.bed_appointment_id ? 'Booked' : 'Empty';
            
            gridHtml += '<div class="bed-grid-item" style="background-color: ' + bedColor + ';">';
            gridHtml += '<img src="path/to/bed/icon.png" alt="Bed">';
            gridHtml += '<p>' + bed.bed_number + '</p>';
            gridHtml += '<p>Status: ' + bedStatus + '</p>';
            gridHtml += '</div>';
          });

          gridHtml += '</div>';

          // Inject the grid HTML into the modal
          $('#bed_availability_modal .modal-body').html(gridHtml);

          // Show the modal
          $('#bed_availability_modal').modal('show');
        } else {
          alert('No data found');
        }
      },
...
<script type="text/javascript">
    $('#ipd_appointment_tab').addClass('active');
    $('#ipd_appointment_form').hide();
  ...
  const  tableData = [];
  function add_record() {
      var deptValue = $("#d_name").val();
      var deptText = $("#d_name option:selected").text();
      var subdeptValue = $("#sd_name").val();
      var subdeptText = $("#sd_name option:selected").text();
      var serviceNameValue = $("#service_name").val();
      var serviceNameText = $("#service_name option:selected").text();

      if (deptValue && subdeptValue && serviceNameValue) {
          ...
          var html = '<tr style="font-size: 18px;">\
                          ...
                          <td style="border-right:1px solid lightgray">' + subdeptText + '</td>\
  ...
  $('.close_model').click(function(){
    $('#view_received_amount').modal('hide');
  ...
  function show_ipd_appointment_form(){


    reset_patient_details_form();
    reset_search_patient_form();
    reset_ipd_appointment_form();
    $('#appointment_slot').val(moment().format('YYYY-MM-DDTHH:mm'));
    $('#appointment_slot').attr('min',moment().format('YYYY-MM-DDTHH:mm'));
    $('#ipd_appointment_tabel').hide();
    $('#ipd_appointment_form').show();
  }

  function show_ipd_appointment_table(){
    $('#ipd_appointment_form').hide();
    $('#ipd_appointment_tabel').show(); 
  }
    ...
    function get_list(){
      ...
      var table=$('#datatable_list').DataTable({
        ...
        'stateSave': true,
        'ajax': {
          'url':'<?=base_url()?>ipd-appointment-list',
        ...
        'columns': [
          ...
          {title: "Bill Amt",data:"amount",mSearch:true},
    ...
    $('#prefix').change(function(){
     ...
     $('#relative_relationship').change(function(){
    ...
    var checkbox = document.getElementById("MLC");
    checkbox.addEventListener('change', function() {
        checkbox.value = this.checked ? 'Yes' : 'No';
    });
  ...
  function updateDateInput() {
    ...
    $('#ipd_appointment_formdata').on('reset',function(event){
      reset_ipd_appointment_form();
    ...
    function add_appointment(){
     ...
     var patient_id= $('#patient_id').val();
      var form = $("#ipd_appointment_formdata")[0];
      var formData = new FormData(form);
      formData.append('patient_id', patient_id);
      if($(form).valid()==true){
        $.ajax({
          url:'<?=base_url()?>ipd-appointment-action',
          method:'post',
          data:formData,
          cache: false,
          contentType: false,
    ...
    $('#ipd_appointment_formdata').on('submit',function(event){
    ...
    $('#ipd_payment_form').on('submit',function(event){
      event.preventDefault(); 
      var result=check_service_amount();

      if(result){
        var form = $( "#ipd_payment_form" );
        var formData = new FormData(this);
        if(form.valid()==true){
          $.ajax({
            url:'<?=base_url()?>ipd-payment-receipt',
            method:'post',
            data:formData,
            cache: false,
            contentType: false,
    ...
    $('#room_number').change(function(){
        ...
        success:function (data) {
          ...
          if(typeof(data)=='object'){
            ...
            var html="<option value='' selected disable>Select Bed</option>";
            for (var i = 0; i <data['record'].length; i++){    
                html+="<option value='"+data['record'][i]["id"]+"' >"+data['record'][i]["name"]+"</option>";
            }
    ...
    $('#d_name').change(function(){
        ...
        success:function (data) {
          ...
          if(typeof(data)=='object'){
            ...
            $("#secondary_doctor").html(html1);
            $('#secondary_doctor').selectpicker('refresh');
   ...
   $(document).on('click','.cancel_record',function () {
    ...
    $(document).on('click','.cancel_appoint',function () {
      ...
      if (appoint_id && reason!='') {
            $.ajax({
                url:'<?=base_url()?>ipd-appointment-cancel',
                method:'post',
                dataType: 'json',
                async: false,
              ...
              success:function(data)
              {
                ...
                for (i=0;i<data['record'].length;i++){
                    ...
                    html+='<tr class="" service_id="'+data['record'][i]['sid']+'">\
                                      ...
                                      <td style="border-right:1px solid lightgray">'+data['record'][i]['sstatus']+'</td>\
                                    </tr>'; 
...
<!-- $(document).ready(function() {
  $('#search_patient_modal').modal({
    backdrop: false,
    show: true
  });

  $('.close_search_patient_modal').click(function() {
    $('#search_patient_modal').modal('hide');
  });
}); -->
