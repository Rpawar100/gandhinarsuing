  ...
  <div class="row" id="opd_appointment_form">
    <div class="col-lg-12" >
      <div class="ibox-title"  style="padding-top: 10px !important;">
        <h2><b>New OPD Billing</b></h2> 
        <button class="btn btn-primary show-inward-table pull-right" onclick="show_opd_appointment_table()"><b>Billing List</b></button>
      </div>
...
<script type="text/javascript">
    $('#opd_billing_tab').addClass('active');
