  ...
  <div class="row">
    <div class="col-lg-4">
      <div class="ibox-title"  style="padding-top: 10px !important;">
        <h3 class="record_form_title">Add Occupation</h3>
      </div>
      <div class="ibox-content">
        <form method="post" enctype="multipart/form-data" id="record_form">
          <div class="row" style="margin: 0px;">
            <label class="form-control col-lg-3" style="border:0px;">Occupation<a style="color: red">*</a><b class="pull-right">:</b></label>
            <div class="col-lg-9">
                <input class="form-control" type="text" name="o_name" id="o_name" maxlength="50" required="" >
                <input class="form-control" type="hidden" name="o_id" id="o_id">
            </div>
          </div><hr>
          <div class="row" style="margin: 0px;">
...
<script type="text/javascript">
  ...
  function get_list(){
    ...
    var table=$('#datatable_list').DataTable({
      ...
      'stateSave': true,
      'ajax': {
        'url':'<?=base_url()?>occupation-list',
      },
      'columns': [
        {title: "Sr.No.",data:"sr_no",mSearch:false},
        {title: "Name",data:"name",mSearch:true},
        {title: "Patient Count",data:"count",mSearch:false},
  ...
  $('#record_form').on('submit',function(event){
    ...
    if(form.valid()==true){
      $.ajax({
        url:'<?=base_url()?>occupation-action',
        method:'post',
        data:formData,
        cache: false,
        contentType: false,
