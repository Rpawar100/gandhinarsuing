...
<body style="background: white">
            <div style="height: 143mm;padding: 5mm;">
                <div>
                    <img alt="OPD Bill Receipt" src="<?=base_url('assets')?>/images/gnadhi_header.png" style="margin:6px;max-width:100%;">
                </div>
                <div class="row">
                ...
                <div class="row" style="font-size: 13px">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="row">
                            ...
                            <label class="col-lg-7"><?=!empty($record['d_name'])?$record['d_name']:'-'?></label>
                        </div>
                    </div>
                </div>
                <div class="row" style="margin: 0px 15px;" >
                        <h5 style="margin: 0px;text-align:center;padding: 10px;border-top: 1px solid black;"><b>Services Details</b></h5>
                </div>
                <div class="row" style="padding: 0px 10px;">
                    <label class="col-lg-2" style="font-weight: bolder;padding:0px;text-align: center;">Sr.No.</label>
                    <label class="col-lg-2" style="font-weight: bolder;padding:0px;text-align: center;">Department</label>
                    <label class="col-lg-3" style="font-weight: bolder;padding:0px;text-align: center;">Services</label>
                    <label class="col-lg-1" style="font-weight: bolder;padding:0px;text-align: center;">Qty</label>
                    <label class="col-lg-2" style="font-weight: bolder;padding:0px;text-align: center;">Rate</label>
                ...
                <?php 
                    ...
                    $totalAmount += !empty($services[$i]['ASA_service_amount']) ? $services[$i]['ASA_service_amount'] : 0;    
                        ?>
                <div class="row" style="padding: 0px 10px;">
                    <label class="col-lg-2"style="padding:0px;text-align: center;"><?=$i+1?></label>
                    <label class="col-lg-2"style="padding:0px;text-align: center;"><?=!empty($services[$i]['department_name'])?$services[$i]['department_name']:'-'?></label>
                    <label class="col-lg-3"style="padding:0px;text-align: center;"><?=!empty($services[$i]['services_name'])?$services[$i]['services_name']:'-'?></label>
                    <label class="col-lg-1"style="padding:0px;text-align: center;">1</label>
                    <label class="col-lg-2"style="padding:0px;text-align: center;">Rs.<?=!empty($services[$i]['ASA_service_amount'])?$services[$i]['ASA_service_amount']:'-'?></label>
                    <label class="col-lg-2"style="padding:0px;text-align: center;">Rs.<?=!empty($services[$i]['ASA_service_amount'])?$services[$i]['ASA_service_amount']:'-'?></label>
                ...
                <div class="row" style="padding: 0px 10px; margin-top: 10px;">
                    <label class="col-lg-9" style="padding:0px;text-align: center;"></label>
                    <label class="col-lg-2" style="padding:0px;text-align: center;"><b>Total Amount</b></label>
                    <label class="col-lg-1" style="padding:0px;text-align: center;"><b>Rs.<?= $totalAmount ?></b></label>
                </div>

                <?php
                if(!empty($record['receipt_timestamp'])){?>
                <br>
                <div class="row" style="margin: 0px 15px;" >
                ...
                <div class="row" style="padding: 0px 10px;">
                    ...
                    <label class="col-lg-3" style="font-weight: bolder;padding:0px;text-align: center;">Timestamp</label>
                    ...
                    <label class="col-lg-2" style="font-weight: bolder;padding:0px;text-align: center;">Total Amount</label>
                    <label class="col-lg-3" style="font-weight: bolder;padding:0px;text-align: center;">Ref.No.</label>
                </div>
                <hr style="margin: 5px;">
                 <div class="row" style="padding: 0px 10px;">
                    <label class="col-lg-1"style="padding:0px;text-align: center;">1</label>
                    <label class="col-lg-3"style="padding:0px;text-align: center;"><?=!empty($record['receipt_timestamp'])?$record['receipt_timestamp']:'-'?></label>
                    ...
                    <label class="col-lg-3"style="padding:0px;text-align: center;"><?=!empty($record['transaction_number'])?$record['transaction_number']:'-'?></label>
                </div>
            <?php } ?>
            </div>
