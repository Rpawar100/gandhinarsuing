  ...
  <div class="row">
    <div class="col-lg-12" id="user_form_page">
      <div class="ibox-title"  style="padding-top: 10px !important;">
        <h3 class="record_form_title">Add Staff</h3>
            ...
            <div id="accordion" class="accordion">
                <div class="card mb-0">
                    ...
                    <div id="collapseone" class="card-body collapse show" data-parent="#accordion">
                        ...
                        <div class="row" style="padding:5px;">
                            ...
                            <div class="col-lg-3">
                                  <select class="form-control" name="designation" id="designation" required="">
                                     <option value='' selected disable>Select Designation</option>
                                  </select>
                              </div>  
                            <div class="col-lg-3">
                        ...
                        <div class="row" style="padding:5px;">
                          <label class="control-label col-lg-2">Employee Number<a style="color: red">*</a></label>
                          <label class="control-label col-lg-2">Specialization<a style="color: red">*</a> </label>
                          <label class="control-label col-lg-2">Date Of Join<a style="color: red">*</a></label>
                          <label class="control-label col-lg-2">Probation Period (In Months)<a style="color: red">*</a></label>
                          <label class="control-label col-lg-2">Confirmation Date<a style="color: red">*</a></label>
                          <label class="control-label col-lg-2">UAN Number</label>
                        </div>
                        <div class="row" style="padding:5px;">
                            <div class="col-lg-2">
                                <input class="form-control" type="text" id="user_number" name="user_number" minlength="10" maxlength="10" required="">
                            </div>
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-2">
                                <input class="form-control" type="date" id="date_of_join" name="date_of_join" required="" onchange="updateConfirmationDate()">
                            </div>
                            <div class="col-lg-2">
                                <input class="form-control" type="text" id="probation_period" name="probation_period" required="" oninput="updateConfirmationDate()">
                            </div>
                            <div class="col-lg-2">
                                <input class="form-control" type="date" id="confirmation_date" name="confirmation_date" required="">
                            </div>
                            <div class="col-lg-2">
                                <input class="form-control" type="text" id="uan_number" name="uan_number" >
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-12" id="user_list_page">
      <div class="ibox-title"  style="padding-top: 10px !important;">
        <h3>Staff List</h3>
          <button class="btn btn-primary pull-right add-user-btn" onclick="show_user_form()"><i class="fa fa-plus"></i> Add Staff </button>
      </div>
