  ...
  <div class="row">
    <div class="col-lg-12" id="opd_appointment_table">
      <div class="ibox-title"  style="padding-top: 10px !important;padding-right: 20px;">
          <div class="row" >
            <div class="col-lg-4">
                <h2><b>Pathologist Dashboard</b></h2>
            </div>
            <div class="col-lg-3">
      ...
      <div class="modal-content" style="border-radius: 15px;">
          <div class="modal-body">
            ...
            <div class="col-lg-12" style="text-align: center;padding: 30px">
              <label style="font-size: x-large;margin: 30px;margin-top: 0px;">Would you like to Approved / Reject this Report ?</label>
            ...
            <button type="button" class="btn update_status" id="Approved_status_update" style="width:32%;color: white;background-color: darkorange;" ASA_id="'+ASA_id+'" ASA_status="'+ASA_status+'" appointment_status="Approved" >Approved !</button>
...
<script type="text/javascript">
  $('#pathologist_tab').addClass('active');
	...
	get_list();
  	...
  	function get_list(){
	    ...
	    var table=$('#datatable_list').DataTable({
	      ...
	      'stateSave': true,
	      'ajax': {
	        'url':'<?=base_url()?>pathologist-appointment-list',
  ...
  $(document).on('click','.update_status',function(){
        ...
        if(flag)
        {
          $.ajax({
            ...
            method:'post',
            data:{ASA_id:ASA_id,appointment_status:appointment_status,reason:reason,ASA_status:ASA_status},
            async: false,
            success:function (data) { 
