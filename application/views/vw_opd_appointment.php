      ...
      <div class="ibox-title"  style="padding-top: 10px !important;padding-right: 20px;">
          <div class="row" >
            ...
            <div class="col-lg-1">
             ...
             <div class="col-lg-2">
              <a href="<?=base_url()?>ipd-appointment" tabindex="-1"><button class="btn btn-primary pull-right " style="top: 0; 1%;
 font-size: medium;"><i class="fa fa-plus"></i>IPD Registration</button></a>
            </div>
            <div class="col-lg-2">
              <button class="btn btn-primary pull-right "  onclick="show_opd_appointment_form()" style="top: 0; 1%;
...
"><?php echo $inprocess_count; ?></h3>
      ...
      <div class="col-md-3">
        <div class="card" style="background-color: #60aad9 !important; border-radius:10px;" id="new_patient_link">
          <div class="card-body">
            <h3 class="card-title" style="text-align: center;color: white !important;font-size: 49px;
"><?php echo $total_opd_new_appointments; ?></h3>
  ...
  <div class="modal-dialog " style="min-width: max-content;">
    <div class="modal-content" style="width: 700px;">
        <div class="modal-header">
          ...
          <button type="button" class="pull-right close_model close_received_amount">&times;</button>
        </div>
...
<script>
  $(document).ready(function() {
    $('#live_patient_link').on('click', function() {
      alert('jjf');
      
      $.ajax({
       'url':'<?=base_url()?>opd-appointment-list?id=1',
...
<script type="text/javascript">
  ...
  function updateDateInput() {
    ...
    $(document).on('click','.close_paybill_model',function () {
     ...
     $(document).on('click','.close_received_amount',function () {
