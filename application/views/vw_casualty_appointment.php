  ...
  <div class="row">
    <div class="col-lg-12" id="opd_appointment_tabel">
      <div class="ibox-title"  style="padding-top: 10px !important;padding-right: 20px;">
          <div class="row" >
            <div class="col-lg-4">
                <h2><b>Emergency Registration List</b></h2>
            </div>
            <div class="col-lg-3">
  ...
  <div class="row" id="opd_appointment_form">
    <div class="col-lg-12" >
      <div class="ibox-title"  style="padding-top: 10px !important;">
        <h2><b>New Emergency Registration</b></h2> 
  ...
  <div class="modal-dialog" style="min-width: max-content;">
    <div class="modal-content">
      <form method="post"  enctype="multipart/form-data" id="opd_appointment_receipt_form">
        <div class="modal-header">
          <h3 class="modal-title">Emergency Bill Receipt</h3>
      ...
      <div class="modal-content" style="border-radius: 15px;">
          <div class="modal-body">
            <div class="row" style="margin-bottom: 15px;">
              <div class="col-lg-12" >
                <h2  style="margin: 0px;float: left;">Emergency Registartion Receipt</h2>
...
<script type="text/javascript">
  ...
  function show_opd_appointment_table(){
    ...
    function get_list(){
      ...
      var table=$('#datatable_list').DataTable({
        ...
        'stateSave': true,
        'ajax': {
          'url':'<?=base_url()?>casualty-appointment-list',
  ...
  function updateDateInput() {
    ...
    function add_appointment(){
      ...
      if($(form).valid()==true){
        $.ajax({
          url:'<?=base_url()?>casualty-appointment-action',
          method:'post',
          data:formData,
          cache: false,
          contentType: false,
              ...
              success:function(data)
              {
                ...
                for (i=0;i<data['record'].length;i++){
                    ...
                    html+='<tr class="" service_id="'+data['record'][i]['sid']+'">\
                                      ...
                                      <td class="change_service_state" style="border-right:1px solid lightgray;color:red"  asa_id="'+data['record'][i]['id']+'">Cancel</td>\
                                    </tr>'; 
